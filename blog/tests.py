...
class TestView(TestCase):
    ...
    def setUp(self):
        ...
        self.post_001.tags.add(self.tag_hello) #Post.objects.create() 안의 인자로 넣지 않는다 => ManyToMany 필드는 여러 개의 레코드 연결 가능하기 때문!
    ...
    def test_create_post(self):
        ...
        self.client.login(username='trump', password='somepassword') # 로그인한 경우 테스트
